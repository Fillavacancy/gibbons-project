...
public class JedisUtil {
    ...
    public static void init() {
        if (jedisPool == null) {
            ...
            jedisPool = new JedisPool(config, RedisConfig.REDIS_IP, RedisConfig.PORT, 10000, RedisConfig.AUTH);
        }
    }
    ...
    public class Keys {
         ...
         *
         * @param key    key
         * @param parame parame 定义排序类型或limit的起止位置.
    ...
    public class Sets {
         ...
         *
         * @param DBindex newkey 新结果集的key
         * @param newkey  newkey 新结果集的key
         * @param keys    ... keys 比较的集合
         * @return 新集合中的记录数
         **/
